        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <div class="panel-body">
                    <h1>Set Question for all Lecture Sessions of {{$unit->name}}</h1>

                    {!! Form::open(['method'=>'POST', 'action'=>'UnitController@storePlease']) !!}
                    ...
                    <a class='btn btn-primary' href="{{url('/unit/'.$unit->id.'/lectures')}}">Back</a>
